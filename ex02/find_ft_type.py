def all_thing_is_obj(object: any) -> int:
    # Diccionario llamado type_names que mapea tipos de datos
    type_names = {
        list: "List",
        tuple: "Tuple",
        set: "Set",
    ...
    # Se intenta obtener un nombre descriptivo para el tipo de objeto usando
    # el diccionario type_names.
